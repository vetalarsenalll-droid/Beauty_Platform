...
export const crmAgentSkills = [
  ...
  },
  {
    ...
    actions: ["notification.send", "notification.campaign.send"],
  ...
  },
  {
    ...
    actions: ["site.service.copy.update", "site.specialist.copy.update", "site.home.copy.update", "site.seo.update"],
  ...
  },
  {
    ...
    actions: ["memory.update", "autopilot.setting.update"],
