...
function normalizePersonToken(raw: string) {
  ...
  const nickMap: Array<[RegExp, string]> = [
    ...
    [/^даш/u, "дарь"],
    [/^дарин/u, "дарь"],
    [/^тан(я|еч|юш|юшк|юх)/u, "татьян"],
    [/^татьян/u, "татьян"],
    [/^кат(я|юш|юшк|юх|ер)/u, "екатерин"],
    [/^екатерин/u, "екатерин"],
    [/^свет(а|ик|икк|лан)/u, "светлан"],
    [/^светлан/u, "светлан"],
    [/^лен(а|оч|очк|к)/u, "елен"],
    [/^елен/u, "елен"],
    [/^ол(я|еч|ечк|ьг)/u, "ольг"],
    [/^ольг/u, "ольг"],
    [/^ир(а|оч|очк|ин)/u, "ирин"],
    [/^ирин/u, "ирин"],
    [/^юл(я|еч|ечк|и)/u, "юли"],
    [/^юли/u, "юли"],
    [/^пол(я|ин|еч|ечк)/u, "полин"],
    [/^полин/u, "полин"],
    [/^вик(а|оч|очк|тор)/u, "виктори"],
    [/^виктори/u, "виктори"],
    [/^алис/u, "алис"],
    [/^ан(я|еч|ечк|н)/u, "анн"],
    [/^анн/u, "анн"],
    [/^мар(и|ин|ус|уc)/u, "мари"],
    [/^марь/u, "мари"],
    [/^марин/u, "мари"],
    [/^жанн/u, "жанн"],
    [/^ларис/u, "ларис"],
    [/^лид/u, "лид"],
    [/^люб(а|ов|оч|очк)/u, "люб"],
    [/^любов/u, "люб"],
    [/^люд(а|мил)/u, "людмил"],
    [/^людмил/u, "людмил"],
    [/^мадин/u, "мадин"],
    ...
    [/^яна/u, "ян"],
    [/^ярослав/u, "ярослав"],
    [/^ал(екс|еш|ешк)/u, "алекс"],
    [/^александ/u, "александр"],
    [/^андр(ей|юш|юх)/u, "андр"],
    [/^арт(ем|емк|ур)/u, "арт"],
    [/^бор(ис|ьк)/u, "борис"],
    [/^вад(им|ик)/u, "вадим"],
    [/^валер/u, "валер"],
    [/^вас(ил|ьк)/u, "васил"],
    [/^виктор/u, "виктор"],
    [/^влад(имир|ик|ислав)/u, "влад"],
    [/^ген(а|над)/u, "геннад"],
    [/^георг/u, "георг"],
    [/^григор/u, "григор"],
    [/^ден(ис|ьк)/u, "денис"],
    [/^дим(а|он|оч|очк)/u, "дмитр"],
    [/^дмитр/u, "дмитр"],
    [/^егор/u, "егор"],
    [/^иван/u, "иван"],
    [/^игор/u, "игор"],
    [/^иль(я|юш)/u, "иль"],
    [/^кирил/u, "кирил"],
    [/^кост(я|ян|еньк)/u, "константин"],
    [/^константин/u, "константин"],
    [/^лев/u, "лев"],
    [/^леон(ид|)/u, "леонид"],
    [/^макс(им|)/u, "максим"],
    [/^матв/u, "матве"],
    [/^мих(аил|а|ась)/u, "михаил"],
    [/^никит/u, "никит"],
    [/^никол/u, "никол"],
    [/^пав(ел|лик)/u, "павел"],
    [/^петр/u, "петр"],
    ...
    [/^руст(ам|ем)/u, "рустам"],
    [/^сем(ен|ён|к)/u, "семен"],
    [/^сер(гей|еж|ежк)/u, "серг"],
    [/^стас/u, "станислав"],
    [/^станислав/u, "станислав"],
    [/^тимур/u, "тимур"],
    [/^фед(ор|я)/u, "федор"],
    [/^юр(ий|к)/u, "юр"],
    [/^ян/u, "ян"],
