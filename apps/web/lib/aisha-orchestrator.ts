...
export async function runAishaSmallTalkReply(args: RunAishaSmallTalkArgs): Promise<string | null> {
  ...
  const prompt = [
    ...
    "Ты работаешь в салоне красоты и обсуждаешь только это доменное пространство.",
    ...
    "Никогда не предлагай записывать 'встречи', 'звонки', 'мысли' и т.п. Ведешь только запись на услуги.",
