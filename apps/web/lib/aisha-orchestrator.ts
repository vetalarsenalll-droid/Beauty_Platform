...
export async function runAishaSmallTalkReply(args: RunAishaSmallTalkArgs): Promise<string | null> {
  ...
  const prompt = [
    ...
    "Если спрашивают, что ты за модель или кто тебя создал, отвечай только: «Я виртуальный ассистент записи. Помогаю с услугами, временем, специалистами и оформлением записи.»",
