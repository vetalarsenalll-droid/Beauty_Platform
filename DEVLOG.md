...
## 2026-04-26
- Date: 2026-04-26
- Task: Site builder services catalog + modal settings
- Summary: Reworked the services site-builder block: fixed card surface rendering, added service photo galleries, modal product-style preview on image click, expanded catalog layout controls, split filters/button/modal settings into clearer sections, and moved button color controls into the button drawer for CRM/public rendering.
- Files: apps/web/features/site-builder/blocks/services/services-catalog.tsx, apps/web/features/site-builder/blocks/services/SE001/content-panel.tsx, apps/web/features/site-builder/blocks/services/SE001/drawers.tsx, apps/web/features/site-builder/blocks/services/SE002/content-panel.tsx, apps/web/features/site-builder/blocks/services/SE002/drawers.tsx, apps/web/features/site-builder/crm/site-services-settings-drawer.tsx, apps/web/features/site-builder/crm/site-services-settings-primary.tsx, apps/web/features/site-builder/crm/site-renderer.tsx, apps/web/app/[publicSlug]/_shared/public-render.tsx, apps/web/app/[publicSlug]/_shared/public-data.ts, apps/web/app/(crm)/crm/site/page.tsx, apps/web/features/site-builder/shared/site-data.ts, apps/web/features/site-builder/crm/site-client-core.ts, DEVLOG.md
- Tests: `npx tsc -p tsconfig.json --noEmit` attempted in `apps/web`; blocked by pre-existing unrelated TypeScript errors outside the services block.
