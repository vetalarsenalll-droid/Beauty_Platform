...
Booking
- appointments, appointment_services, status_history, cancellation_reasons, appointment_holds

Schedule
- schedule_templates, working_hours, breaks, blocked_slots, vacations
