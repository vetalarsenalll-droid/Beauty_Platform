...
const ACCOUNT = {
  name: "Салон красоты Золотая Лилия",
  slug: "zolotaya-liliya",
...
const LOCATION_DATA = [
  {
    code: "A",
    name: "Золотая Лилия — Тверская",
    address: "Москва, Тверская улица, 12",
    description: "Главный салон: волосы, ногти и уходовые процедуры.",
    phone: "+74951230001",
  },
  {
    code: "B",
    name: "Золотая Лилия — Сити",
    address: "Москва, Пресненская набережная, 8",
    description: "Филиал для экспресс-услуг и вечерних укладок.",
    phone: "+74951230002",
  },
  {
    code: "C",
    name: "Золотая Лилия — Юго-Запад",
    address: "Москва, проспект Вернадского, 86",
    description: "Филиал для консультаций и спецсобытий.",
    phone: "+74951230003",
  },
];
...
async function main() {
  console.log("1) Восстановление прав...");
  await ensurePermissions();

  console.log("2) Создание аккаунта...");
  ...
  const account = await prisma.account.create({
    data: {
      ...
      profile: {
        create: {
          description: "Сеть салонов красоты в Москве: волосы, ногти, ресницы и уход.",
          phone: "+74951230000",
          email: "hello@liliya.ru",
          address: "Москва",
          websiteUrl: "https://liliya.local",
        },
      },
      settings: {
        create: {
  ...
  console.log("3) Создание локаций...");
  const locations = [];
  ...
  console.log("4) Создание уровней специалистов...");
  ...
  console.log("5) Создание услуг (30)...");
  ...
  console.log("6) Создание специалистов (15) и привязок...");

  const specialistEmails = SPECIALIST_NAMES.map(
    (_, i) => `spec${String(i + 1).padStart(2, "0")}@liliya.local`
  );
  ...
  for (let i = 0; i < SPECIALIST_NAMES.length; i += 1) {
    ...
    const email = `spec${String(i + 1).padStart(2, "0")}@liliya.local`;
  ...
  console.log("7) Расписание на апрель 2026...");
  ...
  console.log("8) Итоговая проверка...");
  const [
    accountsCount,
    locationsCount,
    specialistsCount,
